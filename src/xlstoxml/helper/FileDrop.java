...
public class FileDrop
{
    ...
    {   this( out,  // Logging stream
              ...
              javax.swing.BorderFactory.createDashedBorder(defaultBorderColor, 2, 4, 4, false),
              false, // Recursive
              listener );
    }   // end constructor
                ...
                {   log( out, "FileDrop: drop event." );
                    ...
                    {   // Get whatever was dropped
                        ...
                        if (tr.isDataFlavorSupported (java.awt.datatransfer.DataFlavor.javaFileListFlavor))
                        {
                            ...
                            java.util.List<java.io.File> fileList = (java.util.List<java.io.File>) 
        ...
        try { 
            ...
            while ((line = bReader.readLine()) != null) {
                try {
                    ...
                    Modules.getConsoleService().error("Error when loading file.");
